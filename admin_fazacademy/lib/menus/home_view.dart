          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Obx(()=> Emploicard(AllClasses: AdminController.instance.MyClasses.where((classe)=> classe.dateTime.day == controller.selectedDate.value.day && classe.dateTime.month == controller.selectedDate.value.month && classe.dateTime.year == controller.selectedDate.value.year).toList().obs,)),
               ...
               SizedBox(height: 20,),
                ...
                TraveauSupCard(title: "درس جديد",sub: "18:00",),
