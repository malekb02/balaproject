...
import 'package:flutter_english_course/modules/menus/widgets/remchangecontroller.dart';
...
class SelectedDateCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        EleveController.instance.selectedClass(classes);
        EleveController.instance.selectedClass.refresh();
